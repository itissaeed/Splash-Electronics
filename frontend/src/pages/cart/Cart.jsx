...
export default function Cart() {
  ...
  if (loading) return <div className="p-6 text-gray-600">Loading cart…</div>;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      {!cart?.items?.length ? (
        <div className="bg-white border rounded-2xl p-8 text-center">
          <div className="text-gray-900 font-bold">Cart is empty</div>
          <Link
            to="/products"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white border rounded-2xl overflow-hidden">
            <div className="px-4 py-3 border-b font-extrabold text-gray-900">Items</div>
                ...
                <div key={it._id} className="p-4 flex gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <div className="font-extrabold text-gray-900">
                      {money(Number(it.priceAtAdd || 0) * Number(it.qty || 0))}
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white border rounded-2xl p-5 h-fit">
            ...
            <div className="mt-4 space-y-2 text-sm">
              ...
              <div className="pt-2 border-t flex justify-between">
                ...
                <span className="font-extrabold text-gray-900">{money(itemsTotal)}</span>
              </div>
            </div>

            <div className="mt-4">
              <label className="text-sm font-semibold text-gray-700">Coupon (optional)</label>
              <input
                value={couponCode}
